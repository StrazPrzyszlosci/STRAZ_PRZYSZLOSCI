...
*   **[10. Łączność Mesh i LoRa (Suwerenna Sieć IoT)](PROJEKTY/10_lacznosc_mesh_lora.md)** – Budowa suwerennej infrastruktury komunikacyjnej odpornej na brak internetu i cenzurę. Wykorzystujemy i optymalizujemy zaawansowane protokoły mesh oraz P2P:
    *   **[Reticulum](https://github.com/markqvist/Reticulum):** Najbardziej elastyczny i odporny stos sieciowy (medium-agnostic) dla zdecentralizowanej komunikacji.
    *   **[p2panda](https://github.com/p2panda/p2panda):** Nowoczesny protokół P2P dla aplikacji offline-first, idealny do synchronizacji danych IoT w rozproszonych węzłach.
    *   **[vossbol / tinySSB](https://github.com/tschudin/vossbol):** Implementacja Secure Scuttlebutt (SSB) na LoRa, umożliwiająca plotkową (gossip) replikację danych i głosu przy minimalnej przepustowości.
    *   **[Meshtastic](https://github.com/meshtastic/firmware):** Najpopularniejsza platforma LoRa Mesh do cywilnej komunikacji tekstowej i telemetrycznej.
    *   **[Deadmesh](https://github.com/gnarzilla/deadmesh):** Pomost Internet-over-LoRa dla kryzysowego dostępu do zasobów sieciowych.
